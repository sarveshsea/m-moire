...
export class OpenCodeDriver extends BaseHarnessDriver {
  ...
  private handleLine(line: string, stream: "stdout" | "stderr"): void {
    ...
    if (parsed === null || typeof parsed !== "object" || Array.isArray(parsed)) {
      this.emitDiagnostic(stream === "stderr" ? "error" : "warn", "invalid object frame from opencode");
      return;
    }
    ...
    try {
      ...
      this.emitDiagnostic(stream === "stderr" ? "error" : "warn", "invalid event frame from opencode");
    }
  }
  ...
  private handleFrame(obj: Record<string, unknown>, stream: "stdout" | "stderr"): void {
    ...
    switch (kind) {
      ...
      case "usage":
        ...
        break;
      default:
        this.emitDiagnostic(stream === "stderr" ? "error" : "warn", `unknown opencode event kind: ${kind}`, obj);
    }
  }
