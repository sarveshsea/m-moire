 ...
 *
 * This script uses the ArkEngine to execute Figma plugin code
...
const envFile = "/Users/sarveshchidambaram/Desktop/ark/.env.local";
try {
...
const { ArkEngine } = await import("../src/engine/core.js");
...
async function main() {
  ...
  try {
    await engine.init();
    console.log("Ark engine initialized");
